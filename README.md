...
| `node bin/heptabase-sync.cjs organize` | **[NEW]** AI 知識整理助手：歸納日誌主題並建議存放白板 |
...
# --days: 回溯天數（預設 7 天）
node bin/heptabase-sync.cjs organize 7
```
...
1. `node bin/heptabase-sync.cjs organize 7` — 採集最近一週日誌資料
